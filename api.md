             ...
             <div class="row align-items-center">
                  <div class="col-lg-6">
                     <div class="about-left wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.2s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.2s; animation-name: fadeInLeft;">
                        ...
                        <p>To use the PayRequest API you need to have a token which ytou can find under settings in your account, always begin with creating a request like:  POST /api/create/
</p>
